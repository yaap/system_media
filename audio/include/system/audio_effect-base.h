...
enum {
    ...
    EFFECT_FLAG_NOT_ELIGIBLE_SUSPEND_SHIFT = 24 /* NO_PROCESS_SHIFT + NO_PROCESS_SIZE */,
    EFFECT_FLAG_NOT_ELIGIBLE_SUSPEND_SIZE = 1,
    /* ((1 << NOT_ELIGIBLE_SUSPEND_SIZE) - 1) << NOT_ELIGIBLE_SUSPEND_SHIFT */
    EFFECT_FLAG_NOT_ELIGIBLE_SUSPEND_MASK = 16777216,
    EFFECT_FLAG_NOT_ELIGIBLE_SUSPEND = 16777216 /* 1 << NOT_ELIGIBLE_SUSPEND_SHIFT */,
};
